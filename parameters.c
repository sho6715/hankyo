...
//			{ 0,		3,	0,	0,		0,	0.1,	0.5,		0,		0,		3,		0,		1,		0,	},	// PARAM_BACK_DEC
		...
		{	//	FFSA	FFS		FFAA	FFA		速度kp		速度ki	速度kd	位置kp	位置ki	角速度kp	角速度ki	角速度kd	角度kp	角度ki	壁kp	壁kd
			...
			{ 0.01,		0.2,	0,		0,		0.5,		0.1,		0,		0,		0,		0.8,		0.05,		0,		0.5,		0.5,		0.3,	0.03,	},	// PARAM_DEC
//			{ 0.0242f*4,3,	0,	0,		0,	0,	0.6,		0,		0,		3.5,		0,		1,		0,	},	// PARAM_BACK_ACC
//			{ 0,		3,	0,	0,		0,	0,	0.6,		0,		0,		3.5,		0,		1,		0,	},	// PARAM_BACK_CONST
//			{ 0,		3,	0,	0,		0,	0.1,	0.5,		0,		0,		3,		0,		1,		0,	},	// PARAM_BACK_DEC
...
//			{ 0,		3,	0,	0,		0,	0.1,	0.5,		0,		0,		3,		0,		1,		0,	},	// PARAM_BACK_DEC
	...
	PRIVATE CONST stGAIN f_TurnGainData[PARAM_MOVE_SPEED_MAX][PARAM_TRUN_MAX] = {
		...
		/* 低速(PARAM_SLOW) */
		{	//	FFSA	FFS		FFAA	FFA		速度kp	速度ki	速度kd	位置kp	位置ki	角速度kp	角速度ki	角速度kd	角度kp	角度ki		壁kp	壁kd
			{ 0.0,		0,		0.016,	0.22,	1.0,	0.1,	0,		0.0,	0,		0.8,		0.0,		0,			0,		0.1,			0,		0,	},	// PARAM_ACC_TRUN
			{ 0,		0,		0.016,	0.22,	1.0,	0.1,	0,		0.0,	0,		0.8,		0.0,		0,			0,		0.1,			0,		0,	},	// PARAM_CONST_TRUN
			{ 0,		0,		0.016,	0.22,	1.0,	0.1,	0,		0.0,	0,		0.8,		0.0,		0,			5,		0.5,			0,		0,	},	// PARAM_DEC_TRUN
		},
		/* 通常(PARAM_NORMAL) */
		{	//	FFSA	FFS		FFAA	FFA		速度kp	速度ki	速度kd	位置kp	位置ki	角速度kp	角速度ki	角速度kd	角度kp	角度ki		壁kp	壁kd
			{ 0.0,		0,		0.016,	0.22,	3.0,	0.1,	0,		2.0,	0,		0.8,		0.0,		0,			0,		0.1,			0,		0,	},	// PARAM_ACC_TRUN
